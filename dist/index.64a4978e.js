...
var _togglePlan = require("./modules/togglePlan");
var _togglePlanDefault = parcelHelpers.interopDefault(_togglePlan);
const header = new (0, _headerDefault.default)();
const togglePlan = new (0, _togglePlanDefault.default)("[data-toggle-trigger='plan']", "[data-toggle-target='plan']", "active", "[data-price='base']", "[data-price='value']");
const togglePaymentMethod = new (0, _togglePlanDefault.default)("[data-toggle-trigger='payment']", "[data-toggle-target='payment']", "active");
header.init();
togglePlan.init();
togglePaymentMethod.init();

},{"./modules/header":"3Lf3r","./modules/togglePlan":"gNX8u","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3Lf3r":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Header {
    ...
    init() {
        if (this.header && this.btn) this.headerEventListener();
        return this;
    }
}
...
},{}],"gNX8u":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class TogglePlan {
    ...
    addActiveClass(index) {
        ...
        if (this.baseValue !== undefined && this.finalValue !== undefined) this.changePrice(index);
    }
...
exports.default = TogglePlan;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hVW7Y","goJYj"], "goJYj", "parcelRequire3add")
